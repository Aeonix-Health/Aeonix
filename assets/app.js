    ...
    const T = {
      "en": {
        ...
        "how.s1d": "Select from Prime Health (100+ biomarkers) to Elite (100+). One-time or annual subscription.",
        ...
        "cmp.th.aeonix": "✦ Aeonix (~90–150 markers)",
      ...
      "de": {
        ...
        "how.s1t": "Plan wählen",
        "how.s1d": "Von Prime Health (100+ Biomarker) bis Elite (~130–150). Einmalig oder als Jahresabo.",
        ...
        "cmp.th.aeonix": "✦ Aeonix (~90–150 Marker)",
      ...
      "fr": {
        ...
        "how.s1d": "De Prime Health (~90–100 marqueurs) à Élite (~130–150). Ponctuel ou abonnement annuel.",
        ...
        "cmp.th.aeonix": "✦ Aeonix (~90–150 marqueurs)",
      ...
      "it": {
        ...
        "how.s1d": "Da Prime Health (~90–100 marcatori) a Elite (~130–150). Una tantum o abbonamento annuale.",
        ...
        "cmp.th.aeonix": "✦ Aeonix (~90–150 marcatori)",
    ...
    function openArticleReader(slug) {
      ...
      var ctas = { de: { h: 'Bereit, Ihre eigenen Werte zu kennen?', p: '100–150+ Biomarker je nach Plan. Ärztlich geprüfte Ergebnisse in 48 Stunden.', btn: 'Gründer-Spot sichern' }, fr: { h: 'Prêt à connaître vos propres valeurs ?', p: "90–150+ biomarqueurs selon le plan. Résultats validés en 48h.", btn: 'Réservez votre place' }, it: { h: 'Pronto a conoscere i tuoi valori?', p: '90–150+ biomarker secondo il piano. Risultati validati in 48 ore.', btn: 'Prenota il tuo posto' } };
    ...
    function aoRender() {
      ...
      ARTICLES.forEach(function (a) {
        ...
        var matchS = aoActiveSection === 'all' || a.section === aoActiveSection;
