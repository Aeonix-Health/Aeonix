...
const T = {
  "en": {
    ...
    "cmp.r14": "Zinc, Magnesium, Selenium",
    "cmp.r15": "PSA, CEA, AFP",
    ...
    "plan.prime.f3": "Full thyroid axis",
    ...
    "plan.vital.f6": "Inflammation (hsCRP)",
    ...
    "plan.lon.f3": "Oncology markers (PSA, CEA, AFP)",
    ...
    "plan.elite.f2": "Cytokine & inflammation panel (hsCRP, IL-6)",
    "plan.elite.f3": "Oncology markers (PSA, CEA, AFP)",
  ...
  "de": {
    ...
    "plan.prime.f3": "Vollständige Schilddrüsenachse",
    ...
    "plan.vital.f5": "Insulin + HOMA-IR",
    "plan.vital.f6": "Entzündung (hsCRP)",
    ...
    "plan.lon.f3": "Onkologie-Marker (PSA, CEA, AFP)",
    ...
    "plan.elite.f2": "Zytokin- & Entzündungspanel (hsCRP, IL-6)",
    "plan.elite.f3": "Onkologie-Marker (PSA, CEA, AFP)",
  ...
  "fr": {
    ...
    "cmp.r14": "Zinc, magnésium, sélénium",
    "cmp.r15": "PSA, ACE, AFP",
    ...
    "plan.prime.f3": "Axe thyroïdien complet",
    ...
    "plan.lon.f3": "Marqueurs oncologiques (PSA, ACE, AFP)",
    ...
    "plan.elite.f2": "Panel cytokines et inflammation (hsCRP, IL-6)",
    "plan.elite.f3": "Marqueurs oncologiques (PSA, ACE, AFP)",
  ...
  "it": {
    ...
    "cmp.r14": "Zinco, magnesio, selenio",
    "cmp.r15": "PSA, CEA, AFP",
    ...
    "plan.prime.f3": "Asse tiroideo completo",
    ...
    "plan.vital.f6": "Infiammazione (hsCRP)",
    ...
    "plan.lon.f3": "Marcatori oncologici (PSA, CEA, AFP)",
    ...
    "plan.elite.f2": "Pannello citochine e infiammazione (hsCRP, IL-6)",
    "plan.elite.f3": "Marcatori oncologici (PSA, CEA, AFP)",
...
const ARTICLES = [
  ...
  { "slug": "burnout-blood-test-switzerland", "section": "Mental & Adrenal Health", "section2": "Stress / Burnout", "date": "2026-04-06", "read_time": "6 min read", "color": "#8C6A4A", "title": "Swiss Workplace Stress Is at a Record High. Here's What It Does to Your Body.", "title_de": "Arbeitsstress in der Schweiz auf Rekordniveau. Das macht er mit Ihrem Körper.", "title_fr": "Le stress au travail atteint un niveau record en Suisse. Voici ce qu'il fait à votre corps.", "title_it": "Lo stress lavorativo in Svizzera è ai massimi storici. Ecco cosa fa al tuo corpo.", "desc": "Swiss employee stress and exhaustion have hit a record high. Here's the measurable biological signature it leaves — and the blood markers Aeonix tests to assess it.", "desc_de": "Stress und Erschöpfung bei Schweizer Arbeitnehmenden haben ein Rekordniveau erreicht. Hier ist die messbare biologische Signatur — und die Blutmarker, die Aeonix dafür testet.", "desc_fr": "Le stress et l'épuisement des salariés suisses ont atteint un niveau record. Voici la signature biologique mesurable qu'il laisse — et les marqueurs sanguins que teste Aeonix.", "desc_it": "Lo stress e l'esaurimento dei lavoratori svizzeri hanno raggiunto un livello record. Ecco la firma biologica misurabile che lasciano — e i marcatori del sangue che testa Aeonix.", "section_de": "Psychische & Nebennierengesundheit", "section_fr": "Santé mentale & surrénalienne", "section_it": "Salute mentale & surrenalica", "body": "<p>Burnout is still, in most clinical settings, managed as a purely psychological condition. What's missing is the biology. Switzerland's most recent Barometer Gute Arbeit (November 2025) found that 42.4% of Swiss employees suffer from stress often or very often, and 41.1% feel emotionally exhausted at the end of a workday — both record highs since 2015. A peer-reviewed meta-analysis in Swiss Medical Weekly puts baseline clinical or severe burnout at around 4% of the working population. Aeonix's Mental & Adrenal Health panel measures cortisol, DHEA-S, hsCRP, and IL-6 — the biological signature chronic stress leaves behind. <a href=\\\"/articles/burnout-blood-test-switzerland.html\\\">Read more →</a></p>", "body_de": "<p>Burnout wird in den meisten klinischen Settings weiterhin rein psychologisch behandelt. Was fehlt, ist die Biologie. Der aktuellste Barometer Gute Arbeit der Schweiz (November 2025) zeigt, dass 42,4% der Schweizer Arbeitnehmenden oft oder sehr oft unter Stress leiden und 41,1% sich am Ende eines Arbeitstages emotional erschöpft fühlen — beide Werte Rekordwerte seit 2015. Eine peer-reviewte Meta-Analyse im Swiss Medical Weekly schätzt klinisches oder schweres Burnout auf rund 4% der erwerbstätigen Bevölkerung. Das Panel für psychische & Nebennierengesundheit von Aeonix misst Cortisol, DHEA-S, hsCRP und IL-6 — die biologische Signatur, die chronischer Stress hinterlässt. <a href=\\\"/articles/burnout-bluttest-schweiz.html\\\">Weiterlesen →</a></p>", "body_fr": "<p>Le burnout reste, dans la plupart des contextes cliniques, géré comme une condition purement psychologique. Ce qui manque, c'est la biologie. Le dernier Baromètre du bon travail de Suisse (novembre 2025) montre que 42,4% des salariés suisses souffrent souvent ou très souvent de stress, et que 41,1% se sentent émotionnellement épuisés à la fin d'une journée de travail — les deux chiffres les plus élevés depuis 2015. Une méta-analyse évaluée par des pairs dans le Swiss Medical Weekly situe le burnout clinique ou sévère à environ 4% de la population active. Le panel Santé mentale & surrénalienne d'Aeonix mesure le cortisol, le DHEA-S, la hsCRP et l'IL-6 — la signature biologique laissée par le stress chronique. <a href=\\\"/articles/test-sanguin-burnout-suisse.html\\\">Lire la suite →</a></p>", "body_it": "<p>Il burnout viene ancora, nella maggior parte dei contesti clinici, gestito come una condizione puramente psicologica. Quello che manca è la biologia. L'ultimo Barometer Gute Arbeit della Svizzera (novembre 2025) mostra che il 42,4% dei lavoratori svizzeri soffre di stress spesso o molto spesso, e il 41,1% si sente emotivamente esausto a fine giornata — entrambi i valori più alti dal 2015. Una meta-analisi sottoposta a peer review su Swiss Medical Weekly stima il burnout clinico o grave al 4% circa della popolazione attiva. Il pannello Salute mentale & suprarenale di Aeonix misura cortisolo, DHEA-S, hsCRP e IL-6 — la firma biologica lasciata dallo stress cronico. <a href=\\\"/articles/analisi-sangue-burnout-svizzera.html\\\">Continua a leggere →</a></p>" },
  ...
  { "slug": "chronic-stress-life-expectancy", "section": "Longevity Science", "date": "2026-08-21", "read_time": "8 min read", "color": "#8C6A4A", "title": "How Much Does Stress Really Shorten Your Life?", "title_de": "Wie stark verkürzt Stress wirklich Ihre Lebenserwartung?", "title_fr": "À quel point le stress raccourcit-il vraiment votre vie\u00a0?", "title_it": "Quanto accorcia davvero lo stress la tua vita?", "desc": "How many years does chronic stress cost you? Population studies say 1.7 to 2.8 years. Here\u2019s what the research actually shows, and what it leaves out.", "desc_de": "Wie viele Jahre kostet Sie chronischer Stress? Bevölkerungsstudien nennen 1,7 bis 2,8 Jahre. Was die Forschung wirklich zeigt, und was sie offen lässt.", "desc_fr": "Combien d\u2019années le stress chronique vous coûte-t-il\u00a0? Les études de population parlent de 1,7 à 2,8 ans. Ce que la recherche montre vraiment, et ce qu\u2019elle laisse de côté.", "desc_it": "Quanti anni ti costa lo stress cronico? Gli studi di popolazione parlano di 1,7-2,8 anni. Ecco cosa mostra davvero la ricerca, e cosa lascia irrisolto.", "section_de": "Longevity Science", "section_fr": "Longevity Science", "section_it": "Longevity Science", "body": "<p>A landmark Finnish cohort study found something striking: people who describe their life as \"almost unbearable\" due to stress have an expected age at death 2.8 years lower than their peers — a smaller but real cost compared to smoking (6.6 years) and diabetes (6.5 years). Here\u2019s what the population data actually shows about stress and lifespan, and which of Aeonix\u2019s stress and adrenal markers can help you track it. <a href=\"/chronic-stress-life-expectancy.html\">Read more →</a></p>", "body_de": "<p>Eine wegweisende finnische Kohortenstudie zeigt: Menschen, die ihr Leben aufgrund von Stress als „fast unerträglich“ beschreiben, haben ein um 2,8 Jahre niedrigeres erwartetes Sterbealter als ihre Altersgenossen — ein kleinerer, aber realer Preis im Vergleich zu Rauchen (6,6 Jahre) und Diabetes (6,5 Jahre). Hier erfahren Sie, was die Bevölkerungsdaten wirklich zeigen, und welche Stress- und Nebennierenmarker von Aeonix Ihnen helfen können. <a href=\"/chronischer-stress-lebenserwartung.html\">Weiterlesen →</a></p>", "body_fr": "<p>Une étude de cohorte finlandaise de référence montre que les personnes décrivant leur vie comme « presque insupportable » à cause du stress ont un âge de décès attendu inférieur de 2,8 ans à celui de leurs pairs — un coût moindre, mais réel, comparé au tabagisme (6,6 ans) et au diabète (6,5 ans). Découvrez ce que montrent réellement les données de population sur le stress et l\u2019espérance de vie, et quels marqueurs de stress et surrénaliens d\u2019Aeonix peuvent vous aider à la suivre. <a href=\"/stress-chronique-esperance-vie.html\">Lire la suite →</a></p>", "body_it": "<p>Uno studio di coorte finlandese di riferimento mostra che le persone che descrivono la propria vita come “quasi insopportabile” a causa dello stress hanno un\u2019età attesa alla morte inferiore di 2,8 anni rispetto ai coetanei — un costo minore, ma reale, rispetto al fumo (6,6 anni) e al diabete (6,5 anni). Scopri cosa mostrano davvero i dati di popolazione su stress e aspettativa di vita, e quali marcatori di stress e surrenali di Aeonix possono aiutarti a monitorarla. <a href=\"/stress-cronico-aspettativa-vita.html\">Continua a leggere →</a></p>" },
  {"slug": "which-preventive-screenings-you-need", "section": "Preventive Medicine", "date": "2026-09-25", "read_time": "6 min read", "color": "#4A8C6F", "title": "Which Preventive Health Screenings Do You Actually Need?", "title_de": "Welche Vorsorgeuntersuchungen brauchen Sie wirklich?", "title_fr": "Quels dépistages préventifs sont vraiment nécessaires ?", "title_it": "Quali screening preventivi ti servono davvero?", "desc": "Guidelines recommend dozens of tests — but which actually apply to you? Here's what USPSTF grades and Swiss cantonal programs say you need, by age, and where they stop.", "desc_de": "Leitlinien empfehlen dutzende Tests — aber welche betreffen Sie wirklich? So lauten die USPSTF-Empfehlungen und die kantonalen Schweizer Programme, nach Alter, und wo sie enden.", "desc_fr": "Les recommandations couvrent des dizaines de tests — mais lesquels vous concernent vraiment ? Voici ce que disent l'USPSTF et les programmes cantonaux suisses, par âge, et où ils s'arrêtent.", "desc_it": "Le linee guida raccomandano decine di test — ma quali ti riguardano davvero? Ecco cosa dicono l'USPSTF e i programmi cantonali svizzeri, per età, e dove si fermano.", "section_de": "Preventive Medicine", "section_fr": "Preventive Medicine", "section_it": "Preventive Medicine", "body": "<p>Guidelines recommend dozens of tests — but which actually apply to you? Here's what USPSTF grades and Swiss cantonal programs say you need, by age, and where they stop. <a href=\"/which-preventive-screenings-you-need.html\">Read more →</a></p>", "body_de": "<p>Leitlinien empfehlen dutzende Tests — aber welche betreffen Sie wirklich? So lauten die USPSTF-Empfehlungen und die kantonalen Schweizer Programme, nach Alter, und wo sie enden. <a href=\"/welche-vorsorgeuntersuchungen-brauche-ich.html\">Weiterlesen →</a></p>", "body_fr": "<p>Les recommandations couvrent des dizaines de tests — mais lesquels vous concernent vraiment ? Voici ce que disent l'USPSTF et les programmes cantonaux suisses, par âge, et où ils s'arrêtent. <a href=\"/quels-depistages-preventifs-necessaires.html\">Lire la suite →</a></p>", "body_it": "<p>Le linee guida raccomandano decine di test — ma quali ti riguardano davvero? Ecco cosa dicono l'USPSTF e i programmi cantonali svizzeri, per età, e dove si fermano. <a href=\"/quali-screening-preventivi-servono.html\">Continua a leggere →</a></p>"},
  {"slug": "complete-preventive-health-exam-explained", "section": "Preventive Medicine", "date": "2026-09-25", "read_time": "6 min read", "color": "#4A8C6F", "title": "What's Actually Included in a Complete Preventive Health Exam?", "title_de": "Was gehört wirklich zu einer umfassenden Vorsorgeuntersuchung?", "title_fr": "Que couvre vraiment un bilan de santé préventif complet ?", "title_it": "Cosa include davvero un esame preventivo completo?", "desc": "A standard check-up and a comprehensive preventive exam are not the same thing. Here's exactly what each one covers, sourced from AAFP and USPSTF guidance.", "desc_de": "Ein Standard-Check-up und eine umfassende Vorsorgeuntersuchung sind nicht dasselbe. Hier erfahren Sie genau, was beide abdecken — gestützt auf AAFP- und USPSTF-Leitlinien.", "desc_fr": "Un bilan de santé standard et un bilan préventif complet ne sont pas la même chose. Voici exactement ce que couvre chacun, sur la base des recommandations de l'AAFP et de l'USPSTF.", "desc_it": "Un controllo standard e un esame preventivo completo non sono la stessa cosa. Ecco esattamente cosa copre ciascuno, sulla base delle linee guida AAFP e USPSTF.", "section_de": "Preventive Medicine", "section_fr": "Preventive Medicine", "section_it": "Preventive Medicine", "body": "<p>A standard check-up and a comprehensive preventive exam are not the same thing. Here's exactly what each one covers, sourced from AAFP and USPSTF guidance. <a href=\"/complete-preventive-health-exam-explained.html\">Read more →</a></p>", "body_de": "<p>Ein Standard-Check-up und eine umfassende Vorsorgeuntersuchung sind nicht dasselbe. Hier erfahren Sie genau, was beide abdecken — gestützt auf AAFP- und USPSTF-Leitlinien. <a href=\"/vorsorgeuntersuchung-inhalt-erklaert.html\">Weiterlesen →</a></p>", "body_fr": "<p>Un bilan de santé standard et un bilan préventif complet ne sont pas la même chose. Voici exactement ce que couvre chacun, sur la base des recommandations de l'AAFP et de l'USPSTF. <a href=\"/bilan-preventif-complet-explique.html\">Lire la suite →</a></p>", "body_it": "<p>Un controllo standard e un esame preventivo completo non sono la stessa cosa. Ecco esattamente cosa copre ciascuno, sulla base delle linee guida AAFP e USPSTF. <a href=\"/esame-preventivo-completo-spiegato.html\">Continua a leggere →</a></p>"},
  {"slug": "how-often-preventive-health-screenings", "section": "Preventive Medicine", "date": "2026-09-25", "read_time": "6 min read", "color": "#4A8C6F", "title": "How Often Should You Actually Get Preventive Health Screenings?", "title_de": "Wie oft sollten Sie wirklich Vorsorgeuntersuchungen machen?", "title_fr": "À quelle fréquence faut-il vraiment se faire dépister ?", "title_it": "Con quale frequenza fare davvero gli screening preventivi?", "desc": "Annual, biennial, every 3 years, every 10 — screening intervals aren't one-size-fits-all. Here's the actual recommended frequency for each major screening, sourced from USPSTF.", "desc_de": "Jährlich, alle zwei Jahre, alle drei, alle zehn — Vorsorgeintervalle sind nicht einheitlich. Hier die tatsächlich empfohlene Häufigkeit für jede wichtige Untersuchung, laut USPSTF.", "desc_fr": "Annuel, tous les deux ans, tous les trois, tous les dix — les intervalles de dépistage ne sont pas uniformes. Voici la fréquence réellement recommandée pour chaque dépistage majeur, selon l'USPSTF.", "desc_it": "Annuale, ogni due anni, ogni tre, ogni dieci — gli intervalli di screening non sono uguali per tutti. Ecco la frequenza realmente raccomandata per ogni screening principale, secondo l'USPSTF.", "section_de": "Preventive Medicine", "section_fr": "Preventive Medicine", "section_it": "Preventive Medicine", "body": "<p>Annual, biennial, every 3 years, every 10 — screening intervals aren't one-size-fits-all. Here's the actual recommended frequency for each major screening, sourced from USPSTF. <a href=\"/how-often-preventive-health-screenings.html\">Read more →</a></p>", "body_de": "<p>Jährlich, alle zwei Jahre, alle drei, alle zehn — Vorsorgeintervalle sind nicht einheitlich. Hier die tatsächlich empfohlene Häufigkeit für jede wichtige Untersuchung, laut USPSTF. <a href=\"/wie-oft-vorsorgeuntersuchungen.html\">Weiterlesen →</a></p>", "body_fr": "<p>Annuel, tous les deux ans, tous les trois, tous les dix — les intervalles de dépistage ne sont pas uniformes. Voici la fréquence réellement recommandée pour chaque dépistage majeur, selon l'USPSTF. <a href=\"/frequence-depistages-preventifs.html\">Lire la suite →</a></p>", "body_it": "<p>Annuale, ogni due anni, ogni tre, ogni dieci — gli intervalli di screening non sono uguali per tutti. Ecco la frequenza realmente raccomandata per ogni screening principale, secondo l'USPSTF. <a href=\"/frequenza-screening-preventivi.html\">Continua a leggere →</a></p>"},
  {"slug": "best-age-start-preventive-care", "section": "Preventive Medicine", "date": "2026-09-25", "read_time": "6 min read", "color": "#4A8C6F", "title": "What's the Right Age to Start Taking Prevention Seriously?", "title_de": "In welchem Alter sollten Sie Vorsorge wirklich ernst nehmen?", "title_fr": "À quel âge faut-il vraiment prendre la prévention au sérieux ?", "title_it": "A che età prendere sul serio la prevenzione?", "desc": "There's no single 'start age' for prevention — it depends what you're screening for. Here's the real age-by-age breakdown, from your 20s through your 60s, sourced from USPSTF guidance.", "desc_de": "Es gibt kein einzelnes 'Startalter' für Vorsorge — es hängt davon ab, worauf gescreent wird. Hier die Aufschlüsselung nach Alter, von den 20ern bis in die 60er, laut USPSTF.", "desc_fr": "Il n'existe pas un « âge de départ » unique pour la prévention — cela dépend de ce que l'on dépiste. Voici la répartition par âge, de la vingtaine à la soixantaine, selon l'USPSTF.", "desc_it": "Non esiste un'unica 'età di partenza' per la prevenzione — dipende da cosa si sta monitorando. Ecco la ripartizione per età, dai 20 ai 60 anni, secondo l'USPSTF.", "section_de": "Preventive Medicine", "section_fr": "Preventive Medicine", "section_it": "Preventive Medicine", "body": "<p>There's no single 'start age' for prevention — it depends what you're screening for. Here's the real age-by-age breakdown, from your 20s through your 60s, sourced from USPSTF guidance. <a href=\"/best-age-start-preventive-care.html\">Read more →</a></p>", "body_de": "<p>Es gibt kein einzelnes 'Startalter' für Vorsorge — es hängt davon ab, worauf gescreent wird. Hier die Aufschlüsselung nach Alter, von den 20ern bis in die 60er, laut USPSTF. <a href=\"/richtiges-alter-vorsorge-beginnen.html\">Weiterlesen →</a></p>", "body_fr": "<p>Il n'existe pas un « âge de départ » unique pour la prévention — cela dépend de ce que l'on dépiste. Voici la répartition par âge, de la vingtaine à la soixantaine, selon l'USPSTF. <a href=\"/bon-age-commencer-prevention.html\">Lire la suite →</a></p>", "body_it": "<p>Non esiste un'unica 'età di partenza' per la prevenzione — dipende da cosa si sta monitorando. Ecco la ripartizione per età, dai 20 ai 60 anni, secondo l'USPSTF. <a href=\"/eta-giusta-iniziare-prevenzione.html\">Continua a leggere →</a></p>"},
  {"slug": "how-to-know-preventive-plan-working", "section": "Preventive Medicine", "date": "2026-09-25", "read_time": "5 min read", "color": "#4A8C6F", "title": "How Do You Know If Your Preventive Care Plan Is Actually Working?", "title_de": "Woran erkennen Sie, ob Ihr Vorsorgeplan wirklich wirkt?", "title_fr": "Comment savoir si votre plan de prévention fonctionne vraiment ?", "title_it": "Come sapere se il tuo piano di prevenzione funziona davvero?", "desc": "Feeling fine isn't proof anything is working. Here's how trend data — not single test results — is what actually tells you whether prevention is paying off.", "desc_de": "Sich gut zu fühlen ist kein Beweis. So zeigt Trenddaten — nicht ein einzelner Testwert — ob Ihre Vorsorge tatsächlich etwas bewirkt.", "desc_fr": "Se sentir bien n'est pas une preuve. Voici comment les tendances — et non un seul résultat — révèlent si votre prévention porte réellement ses fruits.", "desc_it": "Sentirsi bene non è una prova. Ecco come i dati di tendenza — non un singolo risultato — rivelano se la prevenzione sta davvero dando frutti.", "section_de": "Preventive Medicine", "section_fr": "Preventive Medicine", "section_it": "Preventive Medicine", "body": "<p>Feeling fine isn't proof anything is working. Here's how trend data — not single test results — is what actually tells you whether prevention is paying off. <a href=\"/how-to-know-preventive-plan-working.html\">Read more →</a></p>", "body_de": "<p>Sich gut zu fühlen ist kein Beweis. So zeigt Trenddaten — nicht ein einzelner Testwert — ob Ihre Vorsorge tatsächlich etwas bewirkt. <a href=\"/vorsorgeplan-erfolg-erkennen.html\">Weiterlesen →</a></p>", "body_fr": "<p>Se sentir bien n'est pas une preuve. Voici comment les tendances — et non un seul résultat — révèlent si votre prévention porte réellement ses fruits. <a href=\"/savoir-si-plan-prevention-fonctionne.html\">Lire la suite →</a></p>", "body_it": "<p>Sentirsi bene non è una prova. Ecco come i dati di tendenza — non un singolo risultato — rivelano se la prevenzione sta davvero dando frutti. <a href=\"/piano-prevenzione-funziona-davvero.html\">Continua a leggere →</a></p>"},
  {"slug": "can-preventive-care-save-money-long-term", "section": "Preventive Medicine", "date": "2026-09-25", "read_time": "6 min read", "color": "#4A8C6F", "title": "Does Preventive Health Care Actually Save You Money? An Honest Look", "title_de": "Spart Vorsorge langfristig wirklich Geld? Eine ehrliche Betrachtung", "title_fr": "La prévention fait-elle vraiment économiser de l'argent ? Un regard honnête", "title_it": "La prevenzione fa davvero risparmiare denaro? Uno sguardo onesto", "desc": "The population math on prevention is strong. The personal math is more nuanced — and in Switzerland, insurance rarely covers it. Here's the honest picture.", "desc_de": "Auf Bevölkerungsebene ist die Rechnung eindeutig. Auf persönlicher Ebene ist sie differenzierter — und in der Schweiz übernimmt die Versicherung es selten. Hier die ehrliche Sicht.", "desc_fr": "À l'échelle d'une population, le calcul est solide. À l'échelle individuelle, c'est plus nuancé — et en Suisse, l'assurance ne le couvre presque jamais. Voici le tableau honnête.", "desc_it": "A livello di popolazione, il calcolo è solido. A livello individuale è più sfumato — e in Svizzera l'assicurazione raramente lo copre. Ecco il quadro onesto.", "section_de": "Preventive Medicine", "section_fr": "Preventive Medicine", "section_it": "Preventive Medicine", "body": "<p>The population math on prevention is strong. The personal math is more nuanced — and in Switzerland, insurance rarely covers it. Here's the honest picture. <a href=\"/can-preventive-care-save-money-long-term.html\">Read more →</a></p>", "body_de": "<p>Auf Bevölkerungsebene ist die Rechnung eindeutig. Auf persönlicher Ebene ist sie differenzierter — und in der Schweiz übernimmt die Versicherung es selten. Hier die ehrliche Sicht. <a href=\"/vorsorge-spart-langfristig-geld.html\">Weiterlesen →</a></p>", "body_fr": "<p>À l'échelle d'une population, le calcul est solide. À l'échelle individuelle, c'est plus nuancé — et en Suisse, l'assurance ne le couvre presque jamais. Voici le tableau honnête. <a href=\"/prevention-fait-elle-economiser-argent.html\">Lire la suite →</a></p>", "body_it": "<p>A livello di popolazione, il calcolo è solido. A livello individuale è più sfumato — e in Svizzera l'assicurazione raramente lo copre. Ecco il quadro onesto. <a href=\"/prevenzione-fa-risparmiare-denaro.html\">Continua a leggere →</a></p>"},
  {"slug": "preventive-health-measures-for-seniors", "section": "Preventive Medicine", "date": "2026-09-25", "read_time": "6 min read", "color": "#4A8C6F", "title": "Preventive Health After 65: What Actually Moves the Needle", "title_de": "Vorsorge nach 65: Was wirklich etwas bewirkt", "title_fr": "Prévention après 65 ans : ce qui fait vraiment la différence", "title_it": "Prevenzione dopo i 65 anni: cosa fa davvero la differenza", "desc": "Not every screening matters equally as you age. Here's what the evidence says actually reduces risk for adults over 65 — bone density, fall risk, and medication review.", "desc_de": "Nicht jede Untersuchung zählt im Alter gleich viel. Das sagt die Evidenz darüber, was das Risiko für Menschen über 65 tatsächlich senkt — Knochendichte, Sturzrisiko und Medikamente.", "desc_fr": "Tous les dépistages ne se valent pas avec l'âge. Voici ce que dit la science sur ce qui réduit réellement le risque après 65 ans — densité osseuse, chutes et médicaments.", "desc_it": "Non tutti gli screening contano allo stesso modo con l'età. Ecco cosa dice l'evidenza su cosa riduce davvero il rischio dopo i 65 anni — densità ossea, cadute e farmaci.", "section_de": "Preventive Medicine", "section_fr": "Preventive Medicine", "section_it": "Preventive Medicine", "body": "<p>Not every screening matters equally as you age. Here's what the evidence says actually reduces risk for adults over 65 — bone density, fall risk, and medication review. <a href=\"/preventive-health-measures-for-seniors.html\">Read more →</a></p>", "body_de": "<p>Nicht jede Untersuchung zählt im Alter gleich viel. Das sagt die Evidenz darüber, was das Risiko für Menschen über 65 tatsächlich senkt — Knochendichte, Sturzrisiko und Medikamente. <a href=\"/vorsorge-massnahmen-fuer-senioren.html\">Weiterlesen →</a></p>", "body_fr": "<p>Tous les dépistages ne se valent pas avec l'âge. Voici ce que dit la science sur ce qui réduit réellement le risque après 65 ans — densité osseuse, chutes et médicaments. <a href=\"/mesures-prevention-seniors.html\">Lire la suite →</a></p>", "body_it": "<p>Non tutti gli screening contano allo stesso modo con l'età. Ecco cosa dice l'evidenza su cosa riduce davvero il rischio dopo i 65 anni — densità ossea, cadute e farmaci. <a href=\"/misure-prevenzione-anziani.html\">Continua a leggere →</a></p>"},
  {"slug": "questions-to-ask-doctor-checkup", "section": "Preventive Medicine", "date": "2026-09-25", "read_time": "5 min read", "color": "#4A8C6F", "title": "The Questions Most People Forget to Ask at Their Checkup", "title_de": "Die Fragen, die man bei der Vorsorgeuntersuchung meist vergisst", "title_fr": "Les questions que la plupart des gens oublient de poser lors d'un bilan", "title_it": "Le domande che quasi tutti dimenticano di fare durante una visita", "desc": "A good checkup is a conversation, not a form. Here's how to walk in prepared and actually get answers — with a framework used by health researchers themselves.", "desc_de": "Eine gute Vorsorgeuntersuchung ist ein Gespräch, kein Formular. So bereiten Sie sich vor und erhalten wirklich Antworten — mit einer Methode, die Gesundheitsforscher selbst verwenden.", "desc_fr": "Un bon bilan de santé est une conversation, pas un formulaire. Voici comment vous préparer et obtenir de vraies réponses — avec une méthode utilisée par les chercheurs en santé eux-mêmes.", "desc_it": "Una buona visita di controllo è una conversazione, non un modulo. Ecco come prepararsi e ottenere davvero risposte — con un metodo usato dai ricercatori sanitari stessi.", "section_de": "Preventive Medicine", "section_fr": "Preventive Medicine", "section_it": "Preventive Medicine", "body": "<p>A good checkup is a conversation, not a form. Here's how to walk in prepared and actually get answers — with a framework used by health researchers themselves. <a href=\"/questions-to-ask-doctor-checkup.html\">Read more →</a></p>", "body_de": "<p>Eine gute Vorsorgeuntersuchung ist ein Gespräch, kein Formular. So bereiten Sie sich vor und erhalten wirklich Antworten — mit einer Methode, die Gesundheitsforscher selbst verwenden. <a href=\"/fragen-an-arzt-vorsorgeuntersuchung.html\">Weiterlesen →</a></p>", "body_fr": "<p>Un bon bilan de santé est une conversation, pas un formulaire. Voici comment vous préparer et obtenir de vraies réponses — avec une méthode utilisée par les chercheurs en santé eux-mêmes. <a href=\"/questions-a-poser-medecin-bilan.html\">Lire la suite →</a></p>", "body_it": "<p>Una buona visita di controllo è una conversazione, non un modulo. Ecco come prepararsi e ottenere davvero risposte — con un metodo usato dai ricercatori sanitari stessi. <a href=\"/domande-da-fare-medico-visita.html\">Continua a leggere →</a></p>"},
  {"slug": "health-risks-to-ask-doctor-about", "section": "Preventive Medicine", "date": "2026-09-25", "read_time": "5 min read", "color": "#4A8C6F", "title": "The Health Risk Your Doctor Can't See Without Asking You", "title_de": "Das Gesundheitsrisiko, das Ihr Arzt nur sieht, wenn Sie es ansprechen", "title_fr": "Le risque de santé que votre médecin ne peut voir sans que vous le mentionniez", "title_it": "Il rischio per la salute che il medico non può vedere se non lo dici tu", "desc": "Family history changes screening recommendations more than almost anything else — and most people never bring it up. Here's the tool doctors themselves use to fix that.", "desc_de": "Die Familiengeschichte verändert Vorsorgeempfehlungen mehr als fast alles andere — und die meisten sprechen sie nie an. So gehen Ärzte selbst damit um.", "desc_fr": "Les antécédents familiaux modifient les recommandations de dépistage plus que presque tout autre facteur — et la plupart des gens n'en parlent jamais. Voici l'outil que les médecins utilisent eux-mêmes.", "desc_it": "La storia familiare cambia le raccomandazioni di screening più di quasi ogni altro fattore — e quasi nessuno ne parla. Ecco lo strumento che usano gli stessi medici.", "section_de": "Preventive Medicine", "section_fr": "Preventive Medicine", "section_it": "Preventive Medicine", "body": "<p>Family history changes screening recommendations more than almost anything else — and most people never bring it up. Here's the tool doctors themselves use to fix that. <a href=\"/health-risks-to-ask-doctor-about.html\">Read more →</a></p>", "body_de": "<p>Die Familiengeschichte verändert Vorsorgeempfehlungen mehr als fast alles andere — und die meisten sprechen sie nie an. So gehen Ärzte selbst damit um. <a href=\"/gesundheitsrisiken-arzt-fragen.html\">Weiterlesen →</a></p>", "body_fr": "<p>Les antécédents familiaux modifient les recommandations de dépistage plus que presque tout autre facteur — et la plupart des gens n'en parlent jamais. Voici l'outil que les médecins utilisent eux-mêmes. <a href=\"/risques-sante-a-demander-medecin.html\">Lire la suite →</a></p>", "body_it": "<p>La storia familiare cambia le raccomandazioni di screening più di quasi ogni altro fattore — e quasi nessuno ne parla. Ecco lo strumento che usano gli stessi medici. <a href=\"/rischi-salute-da-chiedere-medico.html\">Continua a leggere →</a></p>"},
  {"slug": "importance-of-preventive-care-long-term", "section": "Preventive Medicine", "date": "2026-09-25", "read_time": "6 min read", "color": "#4A8C6F", "title": "Just How Much Does Preventive Care Actually Matter Long-Term?", "title_de": "Wie wichtig ist Vorsorge wirklich für die langfristige Gesundheit?", "title_fr": "Quelle est vraiment l'importance de la prévention sur le long terme ?", "title_it": "Quanto conta davvero la prevenzione nel lungo periodo?", "desc": "Three in four adults already live with a chronic condition, and a large share of chronic disease deaths trace to a short list of modifiable risk factors. Here's what the data actually shows.", "desc_de": "Drei von vier Erwachsenen leben bereits mit einer chronischen Erkrankung, und ein grosser Teil davon geht auf eine kurze Liste beeinflussbarer Risikofaktoren zurück. Das zeigen die Daten.", "desc_fr": "Trois adultes sur quatre vivent déjà avec une maladie chronique, et une grande part de ces maladies remonte à une courte liste de facteurs de risque modifiables. Voici ce que montrent les données.", "desc_it": "Tre adulti su quattro convivono già con una malattia cronica, e gran parte di esse risale a una breve lista di fattori di rischio modificabili. Ecco cosa mostrano i dati.", "section_de": "Preventive Medicine", "section_fr": "Preventive Medicine", "section_it": "Preventive Medicine", "body": "<p>Three in four adults already live with a chronic condition, and a large share of chronic disease deaths trace to a short list of modifiable risk factors. Here's what the data actually shows. <a href=\"/importance-of-preventive-care-long-term.html\">Read more →</a></p>", "body_de": "<p>Drei von vier Erwachsenen leben bereits mit einer chronischen Erkrankung, und ein grosser Teil davon geht auf eine kurze Liste beeinflussbarer Risikofaktoren zurück. Das zeigen die Daten. <a href=\"/bedeutung-vorsorge-langfristige-gesundheit.html\">Weiterlesen →</a></p>", "body_fr": "<p>Trois adultes sur quatre vivent déjà avec une maladie chronique, et une grande part de ces maladies remonte à une courte liste de facteurs de risque modifiables. Voici ce que montrent les données. <a href=\"/importance-prevention-sante-long-terme.html\">Lire la suite →</a></p>", "body_it": "<p>Tre adulti su quattro convivono già con una malattia cronica, e gran parte di esse risale a una breve lista di fattori di rischio modificabili. Ecco cosa mostrano i dati. <a href=\"/importanza-prevenzione-salute-lungo-termine.html\">Continua a leggere →</a></p>"},
  {"slug": "overlooked-preventive-health-practices", "section": "Preventive Medicine", "date": "2026-09-25", "read_time": "6 min read", "color": "#4A8C6F", "title": "Two Preventive Health Habits Almost Everyone Skips", "title_de": "Zwei Vorsorge-Gewohnheiten, die fast jeder auslässt", "title_fr": "Deux habitudes de prévention que presque tout le monde néglige", "title_it": "Due abitudini preventive che quasi tutti trascurano", "desc": "Not every gap in prevention is a missed blood test. Adult vaccination and sleep are two evidence-backed, chronically overlooked preventive practices — here's what the data shows.", "desc_de": "Nicht jede Lücke in der Vorsorge ist ein verpasster Bluttest. Impfungen im Erwachsenenalter und Schlaf sind zwei evidenzbasierte, chronisch vernachlässigte Vorsorgepraktiken.", "desc_fr": "Toutes les lacunes en prévention ne sont pas un bilan sanguin manqué. La vaccination des adultes et le sommeil sont deux pratiques préventives fondées sur des preuves, mais chroniquement négligées.", "desc_it": "Non ogni lacuna nella prevenzione è un esame del sangue mancato. Vaccinazione degli adulti e sonno sono due pratiche preventive basate su evidenze, ma cronicamente trascurate.", "section_de": "Preventive Medicine", "section_fr": "Preventive Medicine", "section_it": "Preventive Medicine", "body": "<p>Not every gap in prevention is a missed blood test. Adult vaccination and sleep are two evidence-backed, chronically overlooked preventive practices — here's what the data shows. <a href=\"/overlooked-preventive-health-practices.html\">Read more →</a></p>", "body_de": "<p>Nicht jede Lücke in der Vorsorge ist ein verpasster Bluttest. Impfungen im Erwachsenenalter und Schlaf sind zwei evidenzbasierte, chronisch vernachlässigte Vorsorgepraktiken. <a href=\"/uebersehene-vorsorge-massnahmen.html\">Weiterlesen →</a></p>", "body_fr": "<p>Toutes les lacunes en prévention ne sont pas un bilan sanguin manqué. La vaccination des adultes et le sommeil sont deux pratiques préventives fondées sur des preuves, mais chroniquement négligées. <a href=\"/pratiques-prevention-negligees.html\">Lire la suite →</a></p>", "body_it": "<p>Non ogni lacuna nella prevenzione è un esame del sangue mancato. Vaccinazione degli adulti e sonno sono due pratiche preventive basate su evidenze, ma cronicamente trascurate. <a href=\"/pratiche-prevenzione-trascurate.html\">Continua a leggere →</a></p>"},
  {"slug": "health-numbers-everyone-should-know", "section": "Preventive Medicine", "date": "2026-09-25", "read_time": "5 min read", "color": "#4A8C6F", "title": "The Handful of Numbers Everyone Should Actually Know About Their Own Body", "title_de": "Die Handvoll Werte, die jeder wirklich über den eigenen Körper kennen sollte", "title_fr": "La poignée de chiffres que tout le monde devrait connaître sur son propre corps", "title_it": "La manciata di numeri che tutti dovrebbero conoscere sul proprio corpo", "desc": "Not your whole lab panel — just the small set of numbers the American Heart Association says matter most, and what the ranges actually mean.", "desc_de": "Nicht der ganze Laborbericht — nur die kleine Anzahl an Werten, die laut American Heart Association am wichtigsten sind, und was die Bereiche tatsächlich bedeuten.", "desc_fr": "Pas tout votre bilan sanguin — juste le petit ensemble de chiffres que l'American Heart Association juge essentiels, et ce que ces plages signifient vraiment.", "desc_it": "Non l'intero referto di laboratorio — solo la piccola serie di numeri che l'American Heart Association ritiene più importanti, e cosa significano davvero questi intervalli.", "section_de": "Preventive Medicine", "section_fr": "Preventive Medicine", "section_it": "Preventive Medicine", "body": "<p>Not your whole lab panel — just the small set of numbers the American Heart Association says matter most, and what the ranges actually mean. <a href=\"/health-numbers-everyone-should-know.html\">Read more →</a></p>", "body_de": "<p>Nicht der ganze Laborbericht — nur die kleine Anzahl an Werten, die laut American Heart Association am wichtigsten sind, und was die Bereiche tatsächlich bedeuten. <a href=\"/gesundheitswerte-die-jeder-kennen-sollte.html\">Weiterlesen →</a></p>", "body_fr": "<p>Pas tout votre bilan sanguin — juste le petit ensemble de chiffres que l'American Heart Association juge essentiels, et ce que ces plages signifient vraiment. <a href=\"/chiffres-sante-a-connaitre.html\">Lire la suite →</a></p>", "body_it": "<p>Non l'intero referto di laboratorio — solo la piccola serie di numeri che l'American Heart Association ritiene più importanti, e cosa significano davvero questi intervalli. <a href=\"/numeri-salute-da-conoscere.html\">Continua a leggere →</a></p>"},
  {"slug": "staying-healthy-without-constant-doctor-visits", "section": "Preventive Medicine", "date": "2026-09-25", "read_time": "5 min read", "color": "#4A8C6F", "title": "How to Stay on Top of Your Health Between Doctor Visits", "title_de": "Wie Sie Ihre Gesundheit zwischen Arztbesuchen im Blick behalten", "title_fr": "Comment rester en bonne santé entre deux visites médicales", "title_it": "Come restare in salute tra una visita medica e l'altra", "desc": "You don't need to see a physician every month to stay ahead of your risk. Here's what the evidence says actually works between appointments — and why it's not nothing.", "desc_de": "Sie müssen nicht jeden Monat zum Arzt, um Ihrem Risiko einen Schritt voraus zu sein. Das sagt die Evidenz darüber, was zwischen Terminen tatsächlich wirkt.", "desc_fr": "Vous n'avez pas besoin de voir un médecin chaque mois pour garder une longueur d'avance sur votre risque. Voici ce que montrent les preuves sur ce qui fonctionne vraiment entre les rendez-vous.", "desc_it": "Non serve vedere un medico ogni mese per restare al passo con il proprio rischio. Ecco cosa dicono le evidenze su ciò che funziona davvero tra un appuntamento e l'altro.", "section_de": "Preventive Medicine", "section_fr": "Preventive Medicine", "section_it": "Preventive Medicine", "body": "<p>You don't need to see a physician every month to stay ahead of your risk. Here's what the evidence says actually works between appointments — and why it's not nothing. <a href=\"/staying-healthy-without-constant-doctor-visits.html\">Read more →</a></p>", "body_de": "<p>Sie müssen nicht jeden Monat zum Arzt, um Ihrem Risiko einen Schritt voraus zu sein. Das sagt die Evidenz darüber, was zwischen Terminen tatsächlich wirkt. <a href=\"/gesund-bleiben-ohne-staendige-arztbesuche.html\">Weiterlesen →</a></p>", "body_fr": "<p>Vous n'avez pas besoin de voir un médecin chaque mois pour garder une longueur d'avance sur votre risque. Voici ce que montrent les preuves sur ce qui fonctionne vraiment entre les rendez-vous. <a href=\"/rester-en-sante-sans-visites-medicales-constantes.html\">Lire la suite →</a></p>", "body_it": "<p>Non serve vedere un medico ogni mese per restare al passo con il proprio rischio. Ecco cosa dicono le evidenze su ciò che funziona davvero tra un appuntamento e l'altro. <a href=\"/restare-in-salute-senza-visite-mediche-continue.html\">Continua a leggere →</a></p>"},
];
